...
const styles = StyleSheet.create({
  ...
  statValue: { fontFamily: 'Menlo', fontSize: s(17), fontWeight: '600', color: colors.fg },
  statLabel: { ...type.chipLabel, color: colors.fg, marginTop: s(2) },
  statDetail: { ...type.rowSub, fontSize: s(9), marginTop: s(1) },
  divider: {
    ...type.divider,
